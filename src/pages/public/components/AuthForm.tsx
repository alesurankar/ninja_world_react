...
const AuthForm = ({ onSuccess }: AuthFormProps) => {
  ...
  return (
    <div className="rounded-xl w-full max-w-4xl bg-white grid grid-cols-2">
      {/* LEFT PANEL */}
      <div className="bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url(${mode === "login" ? Login : Signup})`}}>
        {/* Content */}
              ...
              <p>
                <div>
                  ...
                  <input 
                    ...
                    className="w-full max-w-sm border rounded px-3 py-2 placeholder:text-sm lg:placeholder:text-lg">  
                  </input>
                </div>
